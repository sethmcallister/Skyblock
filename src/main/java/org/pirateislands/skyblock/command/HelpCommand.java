...
public class HelpCommand extends BukkitCommand {
    ...
    public boolean execute(CommandSender sender, String s, String[] args) {
        ...
        sender.sendMessage(" ");
        sender.sendMessage(ChatColor.translateAlternateColorCodes('&', SkyBlock.getPlugin().getServerConfig().getPrimaryColor()) + " Website: " + ChatColor.WHITE + "https://pirateislands.org");
        sender.sendMessage(ChatColor.translateAlternateColorCodes('&', SkyBlock.getPlugin().getServerConfig().getPrimaryColor()) + " Discord: " + ChatColor.WHITE + "https://discord.priateislands.org");
        sender.sendMessage(ChatColor.translateAlternateColorCodes('&', SkyBlock.getPlugin().getServerConfig().getPrimaryColor()) + " Shop: " + ChatColor.WHITE + "store.pirateislands.org");
        sender.sendMessage(ChatColor.GRAY.toString() + ChatColor.STRIKETHROUGH + "-----------------------------------------------------");
        return false;
    }
}
